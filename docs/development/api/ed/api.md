...
!!! github "Merci à MaitreRouge pour la doc"
    Vous pouvez retrouver la documentation originale sur [GitHub :octicons-link-external-24:](https://github.com/EduWireApps/ecoledirecte-api-docs/blob/main/README.md){target='_blank'}
